...
} from "./chunk-ILZ5KYW3.js";
import {
  useThemeProps
} from "./chunk-EMDPWUH6.js";
import {
  require_react_dom
...
import {
  ...
  useRtl,
  useTheme
} from "./chunk-FFUK7MQF.js";
import {
  require_jsx_runtime
} from "./chunk-TS2L5UTY.js";
import {
  __toESM,
  require_react
...
var preprocessSeries = ({
  ...
  series.forEach((seriesData, seriesIndex) => {
    ...
    if (seriesGroups[type]?.series[id] !== void 0) {
  ...
  Object.keys(seriesFormatters).forEach((type) => {
    ...
    if (group2 !== void 0) {
      formattedSeries[type] = seriesFormatters[type]?.(group2, dataset) ?? seriesGroups[type];
    }
  });
...
var formatter4 = (params) => {
  ...
  seriesOrder.forEach((seriesId) => {
    ...
    defaultizedSeries[seriesId] = _extends({
      ...
      }, arcs[index2])).map((item, index2) => _extends({}, item, {
  ...
  const seriesById = React13.useMemo(() => {
    ...
    Object.keys(series).forEach((seriesType) => {
      ...
      Object.keys(seriesData?.series ?? {}).forEach((seriesId) => {
        ...
        map4.set(seriesId, mergeDeprecatedOptions(seriesItem?.highlightScope));
      });
    });
    return map4;
  }, [series]);
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React15.useMemo(() => inZAxis?.map((axisConfig) => {
  ...
  const value = React15.useMemo(() => {
    const allZAxis = zAxis?.map((axis, index2) => _extends({
  ...
  return (0, import_jsx_runtime12.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime12.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime12.jsxs)("g", {
        ...
        }, slotProps?.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime12.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime13.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime13.jsx)(Line, _extends({
      ...
      const skipLabel = typeof tickLabelInterval === "function" && !tickLabelInterval?.(value, index2);
      ...
      return (0, import_jsx_runtime13.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime13.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps?.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime13.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime14.jsxs)(React36.Fragment, {
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(React37.Fragment, {
    children: xTicks.map(({
      value,
      offset
...
var InteractionContext = React40.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React40.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React40.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function ChartsItemTooltipContent(props) {
  ...
  const getColor5 = colorProcessors[series.type]?.(series, xAxisId && xAxis[xAxisId], yAxisId && yAxis[yAxisId], zAxisId && zAxis[zAxisId]) ?? (() => "");
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React45.useMemo(() => {
    const rep = [];
    Object.keys(series).filter(isCartesianSeriesType).forEach((seriesType) => {
      series[seriesType].seriesOrder.forEach((seriesId) => {
        ...
        if (axisKey === void 0 || axisKey === USED_AXIS_ID) {
          ...
          const getColor5 = colorProcessors[seriesType]?.(seriesToAdd, xAxis[xAxisId], yAxis[yAxisId], zAxisId && zAxis[zAxisId]) ?? (() => "");
  ...
  const relevantAxis = React45.useMemo(() => {
...
function useItemTooltip() {
  ...
  const getColor5 = colorProcessors[itemSeries.type]?.(itemSeries, xAxisId && xAxis[xAxisId], yAxisId && yAxis[yAxisId], zAxisId && zAxis[zAxisId]) ?? (() => "");
  if (itemSeries.type === "pie") {
    ...
    const formattedValue2 = itemSeries.valueFormatter?.(value2, {
  ...
  const relevantSeries = Object.keys(series).filter(isCartesianSeriesType).flatMap((seriesType) => {
    ...
    return seriesOfType.seriesOrder.map((seriesId) => {
      ...
      if (axisKey === void 0 || axisKey === USED_AXIS_ID) {
        ...
        const yAxisId = providedYAxisId ?? yAxisIds[0];
        const zAxisId = seriesToAdd.zAxisId ?? seriesToAdd.zAxisKey ?? zAxisIds[0];
        const color2 = colorProcessors[seriesType]?.(seriesToAdd, xAxis[xAxisId], yAxis[yAxisId], zAxisId && zAxis[zAxisId])(dataIndex) ?? "";
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime24.jsxs)("g", {
    className: clsx_default(classes?.series, `${classes?.series}-${id}`),
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React50.useMemo(
  ...
  const padding = React50.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React50.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React50.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React50.useMemo(() => {
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React54.useContext(ZAxisContext);
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React58.useRef({});
  const delauneyRef = React58.useRef(void 0);
  const lastFind = React58.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
  ...
  return (0, import_jsx_runtime32.jsx)(React58.Fragment, {});
}
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React59.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime33.jsx)(React59.Fragment, {});
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react10.forwardRef)((givenProps, givenRef) => {
    ...
    return React60.createElement(Component, { ...usedProps, ref });
  });
};
...
function scheduleProps(callId, { key, props, defaultProps: defaultProps3, state, actions }) {
  return new Promise((resolve, reject) => {
    let delay;
    let timeout;
    let cancel = matchProp(props.cancel ?? defaultProps3?.cancel, key);
    if (cancel) {
      onStart();
    } else {
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React61.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React61.createContext(init));
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(React67.Fragment, {
...
var AnimationContext = React68.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React69.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React70.useContext(AnimationContext);
  if (!isInitialized) {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React72.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime42.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      const offset = isReversed ? 1 - x2 / size : x2 / size;
      return (0, import_jsx_runtime42.jsxs)(React74.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React75.useContext(DrawingContext);
  return React75.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var defaultizeAxis = (inAxis, dataset, axisName) => {
  ...
  return [...inAxis?.map((axis, index2) => _extends({
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React76.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React76.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React77.useRef(null);
...
var ChartContainer = React78.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React79.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React79.useRef(null);
  const [width, setWidth] = React79.useState(0);
  const [height, setHeight] = React79.useState(0);
  const computeSize = React79.useCallback(() => {
...
var ResponsiveChartContainer = React80.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime48.jsx)(LoadingOverlay, _extends({}, props.slotProps?.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = props.slots?.noDataOverlay ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime48.jsx)(NoDataOverlay, _extends({}, props.slotProps?.noDataOverlay));
  }
  return null;
}
...
var BarChart = React84.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  });
...
var useStringInterpolator = (path2) => {
  ...
  const interpolator = React85.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime50.jsxs)(React86.Fragment, {
  ...
  const allData = React89.useMemo(() => {
    ...
    return stackingGroups.flatMap(({
      ...
      return [...groupIds].reverse().map((seriesId) => {
        ...
        const formattedData = xData?.map((x2, index2) => ({
          x: x2,
...
function MarkElement(props) {
  ...
  const {
    axis
  } = React94.useContext(InteractionContext);
  const position = useSpring({
    to: {
      x: x2,
      y: y2
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime59.jsx)("g", {
          ...
          children: xData?.map((x2, index2) => {
            ...
            }, slotProps?.mark), `${seriesId}-${index2}`);
          })
        }, seriesId);
      });
    })
...
function LineHighlightPlot(props) {
  ...
  const {
    axis
  } = React97.useContext(InteractionContext);
...
var LineChart = React98.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React100.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React104.useContext(DrawingContext);
  const skipAnimation2 = useSkipAnimation(inSkipAnimation);
  if (seriesData === void 0) {
    return null;
  }
...
var PieChart = React105.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
...
function Scatter(props) {
  ...
  const cleanData = React106.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
...
function ScatterPlot(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React107.useContext(ZAxisContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime70.jsx)(React107.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
...
var ScatterChart = React108.forwardRef(function ScatterChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
...
var SparkLineChart = React109.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width,
  ...
  return (0, import_jsx_runtime72.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime72.jsx)(BarPlot, {
      ...
      slots,
      slotProps
    }), plotType === "line" && (0, import_jsx_runtime72.jsxs)(React109.Fragment, {
...
var GaugeContext = React110.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React110.useContext(GaugeContext);
}
...
var GaugeContainer = React111.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const svgRef = React111.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
...
var Gauge = React115.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
